...
class SomDST(nn.Module):
    ...
    def forward(self, input_ids, token_type_ids,
        ...
        state_scores, state_output, sequence_output, pooled_output = enc_outputs
        ...
        for b, a in zip(state_output, op_ids.eq(self.update_id)):  # update
            ...
            gathered.append(v)
        decoder_inputs = torch.cat(gathered) # batch, max_update, hidden
        ##########
        ...
        if use_pseudo:
            return state_scores, gen_scores, state_output, sequence_output, pooled_output
...
class Encoder(nn.Module):
    ...
    def forward(self, input_ids, token_type_ids,
        ...
        return state_scores, state_output, sequence_output, pooled_output.unsqueeze(0)

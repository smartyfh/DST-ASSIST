...
def loadData(args):
    ...
    if args.mwz_ver == '2.4':
        ...
        dataset_url = "https://raw.githubusercontent.com/smartyfh/DST-ASSIST/main/data/MULTIWOZ2.0.zip"
...
#     parser.add_argument("--main_dir", type=str, default='data/mwz20')
    parser.add_argument("--mwz_ver", type=str, default='2.0')
#     parser.add_argument("--target_path", type=str, default='data/mwz2.0')
    args = parser.parse_args()
    args.main_dir = 'data/mwz2'+args.mwz_ver.split('.')[1]
    args.target_path = 'data/mwz'+args.mwz_ver
    main(args)
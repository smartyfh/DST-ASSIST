...
from utils.data_utils import make_slot_meta, OP_SET, make_turn_label, postprocessing
...
#     model.encoder.bert = model.encoder.bert.from_pretrained('bert-base-uncased')
...
#                 break
            ...
            gen_ids, max_value, max_update = batch
